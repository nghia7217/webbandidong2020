...
<body>
    <strong><h3 style="text-align: center; font-size:50px">Đăng Kí</h3></strong>
    ...
    <table>
        ...
        <tr>
            <td><input type="submit" name="sub" value="Đăng kí"></td>
        </tr>
    </table>
    </form>
    <?php
        ...
        if(isset($_POST['sub'])){
            ...
            if($tendn==''||$matkhau==''||$hoten==''){
                ...
                echo "Dăng kí thành công! mời <a href='layout.php?page=dn'>Đăng nhập</a>";
            }
        }
    ?>
</body>
