...
<?php
    ...
    $dienthoai= $sql->fetch(PDO::FETCH_ASSOC);
        ...
        echo "<div name ='MaDT' value='$dienthoai[MaDT]'>Tổng tiền: $tongtien</div>";
        $madt=$dienthoai['MaDT'];
        echo "<button><a href='layout.php?page=xldh&id=$result[MaHD]&tongtien=$tongtien'>Xác nhận đơn hàng</a></button>";
        echo "</div>";
    }
    echo "</article>";
?>
